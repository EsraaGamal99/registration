...
import 'package:elmadsarah/Features/Register/UI/Screens/PaymentDone/payment_done_screen.dart';
import 'package:elmadsarah/Features/Register/UI/Screens/SeconfFormScreen/second_form_screen.dart';
import 'package:elmadsarah/Features/Register/UI/Screens/SubjectsScreen/subjects_screen.dart';
...
abstract class AppRouter {
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        path: RoutsName.subjectsScreen,
        name: RoutsName.subjectsScreen, // Add name here
        pageBuilder: (context, state) => buildPageWithDefaultTransition<void>(
          context: context,
          state: state,
        ...
        path: RoutsName.payDoneScreen,
        name: RoutsName.payDoneScreen, // Add name here
        pageBuilder: (context, state) => buildPageWithDefaultTransition<void>(
          context: context,
          state: state,
